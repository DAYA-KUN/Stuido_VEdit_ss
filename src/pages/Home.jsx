...
function Home() {
  ...
  return (
    ...
    {showEditor && <CreativeEditorSDKComponent />}
    
      <div className=" bg-slate-100 w-56 fixed h-screen">
        <NavBar/>
      </div>

      <div className="pl-56 bg-slate-400 overflow-auto" style={{ backgroundImage: "url('src/assets/bg2.png')", backgroundSize: "cover" }}>
        <header className="bg-slate-100 h-20 flex items-center justify-between px-4">
          ...
          <div className="flex items-center">
            <img className="h-14" src="src/assets/profile.png" alt="profile" title="Profile" />
          </div>
        </header>
